...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "52431ca8d8a3bfd2be04";
...
/******/ 	return hotCreateRequire("./src/responsive-containers.js")(__webpack_require__.s = "./src/responsive-containers.js");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./src/responsive-containers.js":
/*!**************************************!*\
  !*** ./src/responsive-containers.js ***!
  \**************************************/
/*! exports provided: getBreakpoints, updateContainerClasses */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getBreakpoints", function() { return getBreakpoints; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "updateContainerClasses", function() { return updateContainerClasses; });
...
var getBreakpoints = function getBreakpoints(node) {
  var breakpoints = defaultBreakpoints;

  if (node && node.dataset && node.dataset.responsiveContainer) {
    breakpoints = JSON.parse(node.dataset.responsiveContainer);

    if (_babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_1___default()(breakpoints) !== 'object') {
      // A data-attr written from React will often be set to `="true"`.
      breakpoints = defaultBreakpoints;
    }
  }

  return Object.keys(breakpoints).reduce(function (carry, className) {
    return carry.concat({
...
var getContainers = function getContainers() {
  return _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(document.querySelectorAll('[data-responsive-container]'));
};
/**
...
var updateContainerClasses = function updateContainerClasses(node, width) {
  // If breakpoints are defined on the observed element,
  // use them. Otherwise use the defaults.
  var breakpoints = getBreakpoints(node);
  var nodeWidth = width || node.getBoundingClientRect().width;
  ...
  for (var i = 0; i < breakpoints.length; i++) {
    ...
    node.classList.toggle(breakpoint.name, breakpoint.size <= nodeWidth && nextBreakpoint.size > nodeWidth);
  }
...
var ro = new resize_observer_polyfill__WEBPACK_IMPORTED_MODULE_2__["default"](function (entries) {
...
var initializeResponsiveContainers = function initializeResponsiveContainers() {
  // Populate the list with the new containers as we register them.
  var activeContainers = {};
  getContainers().forEach(function (container) {
    var existingContainerIndex = containers.indexOf(container);

    if (existingContainerIndex === -1) {
      // Container is new! Observe it.
      ro.observe(container); // Mark the incoming container as active.

      activeContainers[containers.length] = true; // Save a reference to the known container.
  ...
  containers = containers.filter(function (container, idx) {
...
document.addEventListener('DOMContentLoaded', function () {
  initializeResponsiveContainers(); // If the WordPress data module is present, periodially update our container
  ...
  if (window.wp && window.wp.data) {
    ...
    var updateContainers = lodash_debounce__WEBPACK_IMPORTED_MODULE_3___default()(initializeResponsiveContainers, 100);
...
/******/ });
//# sourceMappingURL=responsive-containers.js.map