...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "aee4537dc31d04c95035";
...
var updateContainerClasses = function updateContainerClasses(node, width) {
  ...
  for (var i = 0; i < breakpoints.length; i++) {
    ...
    node.classList.toggle(breakpoint.name, breakpoint.size <= nodeWidth);
  }
...
document.addEventListener('DOMContentLoaded', function () {
  initializeResponsiveContainers(); // If the WordPress data module is present, periodically update our container
